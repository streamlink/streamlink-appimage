...
- Updated build images, with Python 3.14.7

## 8.5.0-1 (2026-08-01)

- Updated Streamlink to 8.5.0, updated its dependencies
- Updated build images, with Python 3.14.6
...
- Updated build images, with Python 3.14.4
...
- Updated build images, with Python 3.14.3
...
- Updated build images, with Python 3.13.5
